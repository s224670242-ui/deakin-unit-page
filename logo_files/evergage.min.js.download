...
c)}var T=function(c,d){return d={exports:{}},c(d,d.exports),d.exports}(function(c,d){c.exports=function(){function a(){for(var a=0,b={};a<arguments.length;a++){var c=arguments[a],d;for(d in c)b[d]=c[d]}return b}function b(c){function d(){}function e(b,e,f){if("undefined"!==typeof document){f=a({path:"/"},d.defaults,f);"number"===typeof f.expires&&(f.expires=new Date(1*new Date+864E5*f.expires));f.expires=f.expires?f.expires.toUTCString():"";try{var g=JSON.stringify(e);/^[\{\[]/.test(g)&&(e=g)}catch(Dg){}e=
c.write?c.write(e,b):encodeURIComponent(String(e)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g,decodeURIComponent);b=encodeURIComponent(String(b)).replace(/%(23|24|26|2B|5E|60|7C)/g,decodeURIComponent).replace(/[\(\)]/g,escape);g="";for(var h in f)f[h]&&(g+="; "+h,!0!==f[h]&&(g+="="+f[h].split(";")[0]));return document.cookie=b+"="+e+g}}function h(a,b){if("undefined"!==typeof document){for(var d={},e=document.cookie?document.cookie.split("; "):[],f=0;f<e.length;f++){var g=
e[f].split("="),h=g.slice(1).join("=");b||'"'!==h.charAt(0)||(h=h.slice(1,-1));try{var n=g[0].replace(/(%[0-9A-Z]{2})+/g,decodeURIComponent);h=(c.read||c)(h,n)||h.replace(/(%[0-9A-Z]{2})+/g,decodeURIComponent);if(b)try{h=JSON.parse(h)}catch(Ye){}d[n]=h;if(a===n)break}catch(Ye){}}return a?d[a]:d}}d.set=e;d.get=function(a){return h(a,!1)};d.getJSON=function(a){return h(a,!0)};d.remove=function(b,c){e(b,"",a(c,{expires:-1}))};d.defaults={};d.withConverter=b;return d}return b(function(){})}()}),R=document,
Aa=window,yb=R.documentElement,ma=R.createElement.bind(R),ad=ma("div"),Pb=ma("table"),Ze=ma("tbody"),bd=ma("tr"),Qb=Array.isArray,da=Array.prototype,tb=da.filter,Ac=da.indexOf,$e=da.map,Ce=da.push,cd=da.slice,wb=da.some,af=da.splice,bf=/^#[\w-]*$/,ye=/^\.[\w-]*$/,cf=/<.+>/,ze=/^\w+$/,Oa=function(){function c(d){var a=1<arguments.length&&void 0!==arguments[1]?arguments[1]:R;ha(this,c);if(d){if(d instanceof Oa)return d;var b=d;if(F(d)){if(b=a instanceof Oa?a[0]:a,b=bf.test(d)?b.getElementById(d.slice(1)):
...
id:!0,currency:!0,inventoryCount:!0,price:!0,tagType:!0,type:!0},rc=function(){var a=0<B('script[src*="//translate.googleusercontent.com"]').length,b=0<B("html.translated-ltr").length||0<B("html.translated-rtl").length;if(a||b)return r.debug("page is translated"),!0;try{var e=0<B(window.parent.document).find('script[src*="//www.microsofttranslator.com"]').length,f=0<B(window.parent.document).find('frame[src*="//www.worldlingo.com"]').length;if(e||f)return r.debug("page is translated"),!0;r.debug("page is not translated");
return!1}catch(g){return r.debug("exception caught, assuming page is untranslated "+g),!1}},ig=function(a){Object.keys(a).forEach(function(b){var e=a[b];Object.keys(e).forEach(function(a){ge[a]||delete e[a]})});return a},jg=function(a){Object.keys(a).forEach(function(b){ge[b]||delete a[b]});return a},he=function(){return k.config&&k.config.settings&&k.config.settings.truncateTranslated&&rc()},kg=["anonymousId"],ie=function(a){(1<arguments.length&&void 0!==arguments[1]?arguments[1]:1)&&td(a);if(!Ka(a))return Promise.resolve(a);
lg(a);mg(a);La.onEventSend(a);return new Promise(function(a){document.addEventListener(l.CustomEvents.OnEventResponse,function(b){b&&b.detail&&b.detail.response&&a(b.detail.response)})})},lg=function(a){var b=K(),e=xa(a.user||{},kg);a.user=t(t({},e||{}),{},{anonId:b.uuid});je(a)},je=function(a){var b=K();b.persistedUserId&&(a.user.encryptedId=b.persistedUserId);b=K();a.account=a.account||{};b.persistedAccountId&&(a.account.encryptedId=b.persistedAccountId);if(b=mc("evergageTestMessages"))a.debug?
a.debug.testMessages=b:a.debug={testMessages:b};b=a.pageView||(a.flags||{}).pageView;a.source=t(t({},a.source||{}),{},{beaconVersion:16,configVersion:p.endpointConfig.siteConfigVersion,contentZones:ng(a.source,b)});if(y.domLoadTime||y.pageLoadTime||y.sdkParseTime||y.sdkLoadTime||y.sdkDnsTime)a.performance=t(t(t(t(t({},y.domLoadTime&&{domLoadTime:y.domLoadTime}),y.pageLoadTime&&{pageLoadTime:y.pageLoadTime}),y.sdkParseTime&&{sdkParseTime:y.sdkParseTime}),y.sdkLoadTime&&{sdkLoadTime:y.sdkLoadTime}),
y.sdkDnsTime&&{sdkDnsTime:y.sdkDnsTime})},ng=function(a,b){return(a.contentZones||[]).reduce(function(a,f){!b&&"object"===A(f)&&(f||{}).name&&r.warn("Using content zone objects in 'sendEvent' will soon be deprecated in favor of zone names as strings");f="string"===typeof f&&""!==f?f:(f||{}).name;"string"===typeof f&&""!==f&&a.push(f);return a},[])},mg=function(a){a.catalog&&0<Object.keys(a.catalog).length&&Object.keys(a.catalog).forEach(function(b){if(a.catalog[b]){if(a.catalog[b].dimensions&&a.catalog[b].relatedCatalogObjects)return x(Error("Catalog cannot include both dimensions and relatedCatalogObjects"),
"Sitemap"),!1;var e=a.catalog[b].relatedCatalogObjects||a.catalog[b].dimensions;e&&"object"===A(e)&&Object.keys(e).forEach(function(a){if(!Array.isArray(e[a]))return x(Error("".concat(a," is not an array. Related Catalog Objects must have type of string[]")),"Sitemap"),!1})}});return!0},og=function(a){a&&("catalogObject"in a?kb(a.catalogObject):"lineItem"in a?kb(a.lineItem):"lineItems"in a?a.lineItems.map(function(a){return kb(a)}):"order"in a&&kb(a.order))},kb=function(a){if("object"===A(a))for(var b=
0,e=Object.keys(a);b<e.length;b++){var f=e[b],g=a[f];if("lineItems"===f&&Array.isArray(g))g.map(function(a){a.catalogObjectId&&"string"===typeof a.catalogObjectId&&(a.catalogObjectId=a.catalogObjectId.trim())});else if("relatedCatalogObjects"===f){f=0;for(var h=Object.keys(g);f<h.length;f++){var k=h[f];Array.isArray(g[k])&&(g[k]=g[k].map(function(a){if("string"===typeof a)return a.trim()}))}}else"catalogObjectId"!==f&&"id"!==f||"string"!==typeof g||(a[f]=g.trim())}},lb=function(a){a:{var b=a,e=k.result.matchedConfig;
...
rc()||(b.interaction&&b.interaction.catalogObject&&he()&&jg(b.interaction.catalogObject),og(b.interaction),je(b),b&&b.source&&Array.isArray(b.source.contentZones)&&0<b.source.contentZones.length||(a=u.matchedConfig)&&b.pageView&&(k.result.matchedConfig=t(t({},a),{},{contentZones:be(a)}),k.result.currentPage=t(t({},k.result.currentPage||{}),{},{source:t(t({},k.result.currentPage.source||{}),{},{contentZones:ce(a)})}),b.source.contentZones=k.result.currentPage.source.contentZones,fe(!1)),La.onEventSend(b))}else r.warn("MCIS Module cannot parse event")},
me=function(a){k.result.matchStatus=u.matchStatus;document.dispatchEvent(new CustomEvent(l.CustomEvents.OnPageMatchStatusUpdated,{detail:{matchStatus:a.detail.matchStatus}}))},ne=function(a){if(a&&a.detail){var b=a.detail.error;var e=a.detail.context;document.dispatchEvent(new CustomEvent(l.CustomEvents.OnException,{detail:{error:b,context:e}}));a={};jc(a);kc(a);a[".em"]=Ja(b.message||b);a[".es"]=e;var f=window.navigator.userAgent.toLowerCase();e="unknown";var g="";switch(!0){case -1<f.indexOf("edge"):e=
"ie";g="edge";break;case -1<f.indexOf("trident"):e="ie";g="trident";break;case -1<f.indexOf("chrome")&&!!window.chrome:g=e="chrome";break;case -1<f.indexOf("firefox"):g=e="mozilla";break;case -1<f.indexOf("safari"):g=e="safari"}"unknown"!==e?(f=(new RegExp("".concat(g,"/(.*?)s"),"gm")).exec(f),f=parseInt(!!f&&f[1]),f=isNaN(f)?null:f):f=null;a[".vt"]=e;f&&(a[".vn"]=f);switch(e){case "safari":Nd(a,b,Jf);break;case "mozilla":Nd(a,b,Kf);break;default:b&&b.stack&&"string"===typeof b.stack&&(b=b.stack.split("\n")[1],
b=b.substring(b.indexOf("at ")+3).match(/(.*) \((.*):(\d+):(\d+)\)/),Array.isArray(b)&&Md(a,{header:b[1],fileName:b[2],line:b[3],column:b[4]}))}Ka(a)&&gb.send(a)}},oe=function(a){document.dispatchEvent(new CustomEvent(l.CustomEvents.OnConsentRevoke,{detail:{revokedConsent:a.detail.revokedConsent}}))},pe=function(a){if(a.detail&&a.detail.newAnonymousId){var b=K();a=a.detail.newAnonymousId;b.uuid!==a&&Z({uuid:a})}},pg=function(a){var b=a.detail.actionEvent;b.interaction&&b.interaction.name===ua.MetadataUpdate&&
(a.preventDefault(),lb({action:ua.MetadataUpdate,consents:b.consents,source:b.source,user:b.user}))},sc=function(){document.removeEventListener(w.OnInitSitemap,ke);document.removeEventListener(w.OnEventSend,le);document.removeEventListener(w.OnPageMatchStatusUpdated,me);document.removeEventListener(w.OnException,ne);document.removeEventListener(w.OnConsentRevoke,oe);document.removeEventListener(w.OnSetAnonymousId,pe)},qg=["cookieDomain","consents"],rg=function(a){return(a.listeners||[]).map(function(a){return ab(a)})},
qe=function(a){yd(a);document.dispatchEvent(new CustomEvent(l.CustomEvents.OnInitSitemap,{detail:{sitemapConfig:k.config}}))},se=function(a){re(a);return!0},te=function(a){k.result.matchedConfig=t(t({},a),{},{contentZones:be(a),listeners:rg(a)});var b=k.result,e=t({},k.result.currentPage||{});var f="function"===typeof a.action?a.action():a.action;var g=a.catalog?a.itemAction||l.ItemAction.ViewItem:null,h=a.name;var m="function"===typeof a.locale?a.locale():a.locale;b.currentPage=t(e,{},{action:f,
itemAction:g,source:{pageType:h,locale:m,contentZones:ce(a)},flags:{pageView:!0},user:{},performance:{},debug:{}});return sg(a)},sg=function(a){return a.itemAction===l.ItemAction.ViewCart||a&&a.cart&&a.cart.complete?tg(a).then(function(a){k.result.currentPage.itemAction=l.ItemAction.ViewCart;k.result.currentPage.cart=a}):a.itemAction===l.ItemAction.Purchase||a&&a.order?ug(a).then(function(a){k.result.currentPage.itemAction=l.ItemAction.Purchase;k.result.currentPage.order=a}):vg(a).then(function(a){k.result.currentPage.catalog=
a})},tg=function(a){var b={};if(!a.catalog&&!a.cart&&!a.order)return Promise.resolve(b);if(a.cart)var e=a.cart;else if(a.order||a.catalog){var f={},g=a.order||a.catalog;Object.keys(g).forEach(function(a){var b=g[a];b&&b.lineItems&&(f[a]=b.lineItems)});e={complete:f}}if(e.complete){a=e.complete;for(var h in a)return Array.isArray(h.match(/[A-Z]/))?"Product"!==h?(x(Error("Item type must be Product"),"Sitewide Javascript"),Promise.resolve(b)):Yf(a[h]):(x(Error("Item types must be capitalized. Did you mean ".concat(h.replace(/^\w/,
function(a){return a.toUpperCase()}),"?")),"Sitewide Javascript"),Promise.resolve(b))}},ug=function(a){var b={};if(!a.catalog&&!a.order)return Promise.resolve(b);a=a.order||a.catalog;for(var e in a)return Array.isArray(e.match(/[A-Z]/))?"Product"!==e?(x(Error("Item type must be Product"),"Sitewide Javascript"),Promise.resolve(b)):bg(a[e]):(x(Error("Item types must be capitalized. Did you mean ".concat(e.replace(/^\w/,function(a){return a.toUpperCase()}),"?")),"Sitewide Javascript"),Promise.resolve(b))},
vg=function(a){var b={};if(!a.catalog)return Promise.resolve(b);for(var e in a.catalog)return Array.isArray(e.match(/[A-Z]/))?wg(a.catalog[e],e):(x(Error("Item types must be capitalized. Did you mean ".concat(e.replace(/^\w/,function(a){return a.toUpperCase()}),"?")),"Sitewide Javascript"),Promise.resolve(b))},wg=function(a,b){return ag(a,b).then(function(a){Object.keys(a).forEach(function(e){a[e]._id||x(Error("Invalid ".concat(b,", missing _id for the ").concat(k.result.matchedConfig.name," page config.")),
"Site-wide Javascript")});return he()?ig(a):a})},xg=function b(){for(var e=arguments.length,f=Array(e),g=0;g<e;g++)f[g]=arguments[g];return f.reduce(function(e,f){Object.keys(f).forEach(function(g){var h=e[g],k=f[g];Array.isArray(h)&&Array.isArray(k)?Object.assign(e,L({},g,h.concat.apply(h,nb(k)))):h&&"object"===A(h)&&k&&"object"===A(k)?Object.assign(e,L({},g,b(h,k))):Object.assign(e,L({},g,k))});return e},{})},ue=function(b){var e=k.config.global||{},f=e.onActionEvent;delete e.onActionEvent;b=xg(e,
b);e.onActionEvent=f;return b},Bg=function(b){try{return yg(b.global),zg(b.pageTypeDefault),Ag(b.pageTypes),!0}catch(e){return x(Error(e),"Sitemap"),!1}},zg=function(b){b&&Object.keys(b).forEach(function(b){if("contentZones"!==b&&"listeners"!==b&&"locale"!==b&&"name"!==b&&"onActionEvent"!=b)throw Error("".concat(b," is not a valid default config attribute."));})},yg=function(b){b&&Object.keys(b).forEach(function(e){if("contentZones"!==e&&"listeners"!==e&&"locale"!==e&&"onActionEvent"!=e)throw Error("".concat(e,
" is not a valid global config attribute."));if("contentZones"===e&&b[e]&&!Array.isArray(b[e]))throw Error("global config: contentZones must be provided as an array of objects");})},Ag=function(b){b.forEach(function(b){if(!b.name||!b.isMatch)throw Error("All page configs must have a name and isMatch attribute defined");if(b&&b.contentZones&&!Array.isArray(b.contentZones))throw Error("".concat(b.name," pageType config: contentZones must be provided as an array of objects"));})},Cg=function(){var b=
k.result;lb(k.result.currentPage);k.result=b},re=function(b){qe(b);md();hg();jb();if(k.config.settings.runOnTranslatedPage||!rc())k.result.currentPage=null,Bg(b)&&Za(b.pageTypes).then(ue).then(te).then(Cg).then(function(){return fe()}).catch(function(b){"sitemap_reinit"!==b&&x(Error("Unhandled exception: ".concat(b)),"Site-wide Javascript")})};a:{try{if("undefined"!==typeof document&&document.currentScript){var Zc=document.currentScript;break a}}catch(b){}Zc=null}window.SalesforceInteractions||(window.SalesforceInteractions=
{});window.Evergage||(window.Evergage={});window.Evergage.CustomEvents=l.CustomEvents;var tc=function(){window.SalesforceInteractions||(window.SalesforceInteractions={});window.SalesforceInteractions.mcis&&window.SalesforceInteractions.mcis.sendStat||(window.SalesforceInteractions.mcis={extractFirstGroup:wa.extractFirstGroup,getLastPathComponentWithoutExtension:wa.getLastPathComponentWithoutExtension,getParameterByName:wa.getParameterByName,getValueFromNestedObject:wa.getValueFromNestedObject,buildLineItemFromPageState:Zd,
buildLineItemFromBasePageState:Zd,cookie:wa.cookie,sendStat:ve,getContentZoneSelector:de,getSdkConfig:Fd,getSitemapConfig:Kd,getSitemapResult:Jd,getCampaignResponses:Ld,CustomEvents:pa,ConsentPurpose:dc,CatalogObjectInteractionName:Ea,discoverNonce:Yc,applyNonceToElement:$c})},uc=function(){window.Evergage&&"object"===A(window.Evergage)||(window.Evergage={});window.Evergage.CustomEvents&&window.Evergage.CustomEvents.OnEventSend||(window.Evergage.CustomEvents=l.CustomEvents)};document.addEventListener(w.OnInit,
...
f=xa(f,qg);b&&(p.beaconConfig.cookieDomain=b);e&&(p.beaconConfig.consents=e);var g=p.endpointConfig;b=g.account;e=g.dataset;g=g.trackerUrl;p.beaconConfig=t(t({},p.beaconConfig),{},{trackerUrl:g},f);f=Fd();g=document.dispatchEvent(new CustomEvent(l.CustomEvents.OnInit,{detail:{beaconConfig:f},cancelable:!0}));document.dispatchEvent(new CustomEvent(pa.OnInit,{detail:{sdkConfig:f}}));g?(P.setCookieHash(b,e,ea),g=P.read("a"),f=P.read("n"),Id(g)?(Z(Hd(g)).uuid!==U&&ic(),r.debug("Loaded visitor record from cookie: ".concat(JSON.stringify(K())))):
...
ic(),r.debug("Classic cookie detected with anonymousId: ".concat(K().uuid))):(kd()?Z({uuid:U}):(Z({uuid:Qc()}),ic()),r.debug("Created new visitor record. anonymousId: ".concat(K().uuid))),K(),f=p.beaconConfig.trackerUrl,La=new gg(f+"/api2/event/"+p.endpointConfig.dataset,La?La.eventRateLimiter:null),eb=new Xf(f+"/msreceiver",eb?eb.eventRateLimiter:null),fb=new Wf(f+"/pr",fb?fb.eventRateLimiter:null),gb=new Vf(f+"/er",gb?gb.eventRateLimiter:null),sc(),document.addEventListener(w.OnInitSitemap,ke),
document.addEventListener(w.OnEventSend,le),document.addEventListener(w.OnPageMatchStatusUpdated,me),document.addEventListener(w.OnException,ne),document.addEventListener(w.OnConsentRevoke,oe),document.addEventListener(w.OnSetAnonymousId,pe),fg.setupActivityTimers(),r.debug("Initialized Tracking Beacon v".concat(16," for account[").concat(b,"] dataset[").concat(e,"]")),p.beaconState="running"):(sc(),r.debug("Cancelling activity tracking."),clearTimeout(X),X=-1,ca(window,"pagehide",Lb),ca(window,"blur",
Mb),ca(window,"focus",Nb),ca(document,"mousemove keydown scroll click",Fa),r.debug("IS Module initialization canceled due to a preventDefault call in a listener for the OnInit event."))}});document.addEventListener(w.OnShutDown,function(b){b=b.detail.message;r.info("Shutting down MCIS Module: ".concat(b));document.dispatchEvent(new CustomEvent(l.CustomEvents.OnShutDown,{detail:{message:b}}));p.beaconState="shutDown";sc()});document.addEventListener(w.OnBeforeInit,function(b){tc();uc();gd=p.beaconConfig.secureCookie?
!0:!1});var we=function(){var b=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};return new Promise(function(e){document.addEventListener(w.OnBeforeEventSend,pg);bc(b).catch(function(b){});"running"===p.beaconState&&e(p)})},ve=function(b){var e=[];b.campaignStats.forEach(function(b){var f=k.campaignResponses.find(function(e){return e.experienceId===b.experienceId});document.dispatchEvent(new CustomEvent(l.CustomEvents.OnStatSend,{detail:{campaignStat:b,campaignResponse:f}}));document.dispatchEvent(new CustomEvent(pa.OnStatSend,
{detail:{campaignStat:b,campaignResponse:f}}));e.push(b.experienceId)});e=Array.from(new Set(e));return Ka(b)?eb.send(Qf(b),e):Promise.resolve(b)};tc();uc();l.ConsentPurpose=dc;l.DisplayUtils=Ed;l.addEventListener=function(b){r.warn("Evergage.addEventListener is deprecated. Use the Evergage.CustomEvents.OnEventSend event instead.");return null};l.addResponseListener=function(b){r.warn("Evergage.addResponseListener is deprecated. Use the Evergage.CustomEvents.OnEventResponse event instead.");return null};
l.applyNonceToElement=$c;l.build=function(b){Za(b.pageTypes).then(ue).then(te).catch(function(b){"sitemap_reinit"!==b&&x(Error("Unhandled exception: ".concat(b)),"Site-wide Javascript")})};l.cashDom=B;l.configure=function(b,e){"running"==p.beaconState&&r.debug("Unbinding signal subscriptions.");p.beaconState="initializing";p.endpointConfig=t(t({},p.endpointConfig),b);var f=p.endpointConfig;b=f.account;var g=f.dataset;f=f.siteConfigVersion;if(!b||!g)return W("account/dataset undefined. Check your beacon configuration.");
if(!f)return W("beacon config version undefined");p.endpointConfig.cdnUrl||(p.endpointConfig.cdnUrl="https://".concat(Hf));if(!p.endpointConfig.cdnUrl)return W("cdnUrl undefined. Check your beacon configuration.");p.endpointConfig.trackerUrl||(f=p.endpointConfig,b="https://".concat({account:b,dataset:g}.account,".").concat("evergage.com"),f.trackerUrl=b);if(!p.endpointConfig.trackerUrl)return W("trackerUrl undefined. Check your beacon configuration.");p.beaconConfig.trackerUrl=p.endpointConfig.trackerUrl;
p.beaconConfig=t(t({},p.beaconConfig),e);p.beaconState="configured"};l.discoverNonce=Yc;l.getCampaignResponses=Ld;l.getConfig=fc;l.getConsents=od;l.getContentZoneSelector=de;l.getCurrentPage=Vc;l.getLoggingLevel=Pc;l.getSitemapConfig=Kd;l.getSitemapResult=Jd;l.getState=db;l.getVersion=function(){return 16};l.init=we;l.initSitemap=se;l.listener=function(b,e,f){var g="object"===A(f)?function(){r.warn("ListenerOptions are deprecated. Please use a callback in the Listener instead.");var b=t(t({},f),{},
{user:{}});lb(b)}:f;return Rc(b,e,g)};l.log=r;l.reinit=function(){var b=O.map(function(b){return b.consent});we(t(t({},fc()),{},{consents:b})).then(function(){se(k.config)})};l.removeCookies=function(b){b&&P.setCookieHash(p.endpointConfig.account,p.endpointConfig.dataset,b);document.dispatchEvent(new CustomEvent(w.OnClearCookie,{detail:{options:{domain:b||p.beaconConfig.cookieDomain||hc(location.hostname)}}}))};l.resolvers=Cd;l.runSpecificConfig=function(b){Object.assign(k.config,{pageTypes:[b]});
re(k.config)};l.sendEvent=lb;l.sendException=x;l.sendStat=ve;l.setConfig=qe;l.setLoggingLevel=Oc;l.shutDown=W;l.updateConsents=Yb;l.util=wa;return l}({});
window.evergageBeaconParseTimeEnd = (new Date().getTime());

(function configureEvergage() {
    try {
       Evergage.configure({
           account: "deakinuniversity",
           dataset: "domestic",
           cdnUrl: "https://cdn.evergage.com",
           trackerUrl: "https://deakinuniversity.australia-3.evergage.com",
           siteConfigVersion: "193"
       },{"allowBotTraffic":false,"corsAllowedOrigins":["*"],"defaultCurrency":"AUD","defaultLocale":null,"disableQtipWindowScroll":false,"doNotStoreCookiesRequireProvidedAnonId":false,"doNotTrackPingRequestsForActions":false,"enableCorsRestrictedOrigins":false,"enableCrossDomainIframeCookies":false,"enableMessageRotation":false,"enableRememberMeUserIds":false,"enableTemplateEsc":false,"hideContentSections":false,"hideContentSectionsMillis":2500,"hidePagesForRedirect":false,"hidePagesForRedirectMillis":1000,"identityAttributes":["customerId","emailAddress","profileId","sfmcContactKey","studentId"],"lastModified":1730167934612,"preventSensitiveDataCapture":false,"rememberMeUserIdsMillis":63072000000,"secureCookie":true,"sendErrorEvents":true,"showPoweredBy":false,"siteConfigExecBeforePageReady":false,"spaRouteChangeTimeout":500,"trackAnonymousVisitors":true,"trackContextualRelatedItems":false,"trackSubdomainAsCompany":false,"trackUnknownPagesByTitle":false,"treatHashChangeAsPageLoad":false}       );
    } catch (e) {
          console.error(e);
    }
})();
...
if (!(/(international$|\/international-students\/|\/_admin\/)/.test(window.location.pathname)))  {
    // initialising content zones (MBOX Markers) object
    var mcpLoad = false;
    var mcpPageMbox = [];
    var pageActionName = '';
    var pageTypeName = '';
    ...
    // enable pageTypes and pages in this section, including content boxes(mcpPageMbox)
    // add new pages for deakin post home page declaration
    
    switch (true) {
    //international course pages catch
    case ((/\/course\//.test(window.location.pathname)) && (/International/.test(window.document.querySelector("meta[name='dkncoursestudent']").content))):
        mcpLoad = false;
        window.console.log("MCP::International");
        //stop everything from loading as this is an international course page
    	break;
    
    // Openday microsite
    case (/openday/.test(window.location.hostname)):
        mcpLoad = true;
        pageTypeName = 'openday';
        pageActionName = 'openday:' + ((window.location.pathname.length > 1) ? (window.location.pathname).slice(1) : 'openday') + ':pageView';
        // Declare each mbox for the specific page explicitly with name and JS path selector
        mcpPageMbox[0] = {
            name: 'openday-herobanner',
            selector: 'section[data-module="hero-banner"]'
    	};
    	break;
    	
    // Graduate Research microsite
    case (/graduateresearch/.test(window.location.hostname)):
        mcpLoad = true;
        pageTypeName = 'graduateresearch';
        pageActionName = 'graduateresearch:' + ((window.location.pathname.length > 1) ? (window.location.pathname).slice(1) : 'graduateresearch') + ':pageView';
        // Declare each mbox for the specific page explicitly with name and JS path selector
        mcpPageMbox[0] = {
            name: 'graduateresearch-herobanner',
            selector: 'section[data-module="hero-banner"]'
    	};
    	break;	
    	
    // Change of preference microsite	
    case (/changeofpreference/.test(window.location.hostname)):
        mcpLoad = true;
        pageTypeName = 'changeofpreference';
        pageActionName = 'changeofpreference:' + ((window.location.pathname.length > 1) ? (window.location.pathname).slice(1) : 'changeofpreference') + ':pageView';
        // Declare each mbox for the specific page explicitly with name and JS path selector
        mcpPageMbox[0] = {
            name: 'graduateresearch-herobanner',
            selector: 'section[data-module="hero-banner"]'
    ...
    // ATAR microsite
    case (/atar-calculator/.test(window.location.hostname)):
    	mcpLoad = true;
    	pageTypeName = 'atar-calculator';
    	pageActionName = 'atar:' + ((window.location.pathname.length > 1) ? (window.location.pathname).slice(1) : 'atar-calculator') + ':pageView';
    	// Declare each mbox for the specific page explicitly with name and JS path selector
    	mcpPageMbox[0] = {
    		name: 'atar-logo',
    		selector: '.main-menu a.logo'
    	};
    	break;

    // study apply microsite
    case (/study/.test(window.location.hostname) && /\/apply(\/|\/.*)/.test(window.location.pathname)):
        mcpLoad = true;
        pageTypeName = 'study_apply';
        
        pageActionName = 'study:apply:pageView';
        
        if (/success=true/.test(window.location.search) && /studyLevel=postgraduate/.test(window.location.search)) {
            pageActionName = 'study:course-guides-postgrad_thankyou:pageView';
        } else if (/success=true/.test(window.location.search) && /studyLevel=undergraduate/.test(window.location.search)) {
            pageActionName = 'study:course-guides-undergrad_thankyou:pageView';
        } else if (/success=true$/.test(window.location.search)) {
            pageActionName = 'study:course-guides-any_thankyou:pageView';
        } else {
            pageActionName = 'study:apply:pageView';
        }
        ...
        mcpPageMbox[0] = {
            name: "study-banner",
            selector: '.landing-2025-banner'
        };
        mcpPageMbox[1] = {
            name: "study-logo",
            selector: '.deakin-logo'
        };
        mcpPageMbox[2] = {
            name: "study-contactus",
            selector: "section.contact-us"
        };
        mcpPageMbox[3] = {
            name: "study-graduate-jobs",
            selector: ".section-2022.graduate-jobs"
        };
        mcpPageMbox[4] = {
            name: "study-stats-component",
            selector: ".section-2022.stats-component"
        };
        mcpPageMbox[5] = {
            name: "study-body",
            selector: ".body.landing-2022, body.landing-2025"
        };
        mcpPageMbox[6] = {
            name: "study-flexible-learning",
            selector: ".section-2022.flexible-learning"   
        };
        mcpPageMbox[7] = {
            name: "study-online-study",
            selector: ".section-2022.online-study"   
        };
        mcpPageMbox[8] = {
            name: "study-online-triangle1",
            selector: ".main > :nth-child(4)"   
        };
        break;


    case (/study/.test(window.location.hostname) && /\/webinar(\/|\/.*)/.test(window.location.pathname)):
        mcpLoad = true;
        pageTypeName = 'study_webinar';
        
        pageActionName = 'study:webinar:pageView';
        
        if (/success=true/.test(window.location.search) && /studyLevel=postgraduate/.test(window.location.search)) {
            pageActionName = 'study:webinar_postgrad_thankyou:pageView';
        } else if (/success=true/.test(window.location.search) && /studyLevel=undergraduate/.test(window.location.search)) {
            pageActionName = 'study:webinar_undergrad_thankyou:pageView';
        } else if (/success=true$/.test(window.location.search)) {
            pageActionName = 'study:webinar_any_thankyou:pageView';
        } else {
            pageActionName = 'study:webinar:pageView';
        }
    ...
    // study microsite
    /*
    case (/study/.test(window.location.hostname)):
    	mcpLoad = true;
    	pageTypeName = 'study_course-guides';
    	pageActionName = (/success=true/.test(window.location.search)) ? 'study:course-guides-any_thankyou:pageView' : 'study:course-guides:pageView';
    	pageActionName = (/studyLevel=postgraduate/.test(window.location.search)) ? 'study:course-guides-postgrad_thankyou:pageView' : ((/dcg=Undergrad/.test(window.location.search)) ? 'study:course-guides-undergrad_thankyou:pageView' : pageActionName);
    	mcpPageMbox[0] = {
            name: "study-banner",
            selector: 'section[data-type="header-banner"]'
        };
        mcpPageMbox[1] = {
            name: "study-logo",
            selector: '.deakin-logo'
   ...
   */
    ...
    case (/^\/$/.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'home';
    	pageActionName = 'deakin:homepage:pageView';
    	// Declare each mbox for the specific page explicitly below in combination of name and JS path selector
        mcpPageMbox[0] = {
    		name: "homepage_hero_banner",
    		selector: ".homepage-banner.homepage-banner__slider"
    	};
        mcpPageMbox[1] = {
    		name: "homepage_search_course",
    		selector: "section.homepage-course-search"
    	};
        mcpPageMbox[2] = {
    		name: "homepage_proofpoints",
    		selector: "section.homepage-dark-proofpoints"
    	};
    	break;
    
    /******************* Add New Pages for public deakin.edu.au below this section ***************/
    // events pages
    case (/\/events/.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'events';
    	pageActionName = 'deakin:events-' + window.location.pathname.split('/').pop() + ':pageView';
    	/*mcpPageMbox[0] = {
    		name: "navigation_logo",
    		selector: ".global-header__navigation > .logo"
    	};*/
    	break;
        
    // Support for high school students - sub pages
    case (/\/support-for-high-school-students(\/.*)?$/.test(window.location.pathname)):
        mcpLoad = true;
        pageTypeName = 'high-school-support';
        pageActionName = 'deakin:support-for-high-school:pageView';
        /*mcpPageMbox[0] = {
    		name: "navigation_logo",
    		selector: ".global-header__navigation > .logo"
    	};*/
    ...
    /******************* Add New Pages for public deakin.edu.au above this section ***************/
    
    // fees-and-scholarships deakin pages
    case (/\/study\/fees-and-scholarships/.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'fees-and-scholarships';
    	pageActionName = 'deakin:fees-and-scholarships_v74:pageView';
    	/*mcpPageMbox[0] = {
    		name: "navigation_logo",
    		selector: ".global-header__navigation > .logo"
    	};*/
    ...
    // study how-to-apply deakin pages
    case (/\/study\/how-to-apply$/.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'how-to-apply';
    	pageActionName = 'deakin:how-to-apply_e49:pageView';
    	/*mcpPageMbox[0] = {
    		name: "navigation_logo",
    		selector: ".global-header__navigation > .logo"
    	};*/
    ...
    case (/\/study\/how-to-apply\/(undergraduate|postgraduate)-applications/.test(window.location.pathname)):
        mcpLoad = true;
    	pageTypeName = 'how-to-apply-grade';
    	pageActionName = 'deakin:how-to-apply_'+window.location.pathname.split('/').pop()+':pageView';
        break;

    // study how-to-apply Level 3
    case (/\/study\/how-to-apply\/(preparing-your-application(\/.*)?|recognition-of-prior-learning)/.test(window.location.pathname)):
        mcpLoad = true;
    	pageTypeName = 'how-to-apply';
    	pageActionName = 'deakin:how-to-apply-preparing-application:pageView';
        break; 

    // study how-to-apply Level 4
    case (/\/study\/how-to-apply\/equity-schemes.*/.test(window.location.pathname)):
        mcpLoad = true;
    	pageTypeName = 'how-to-apply';
    	pageActionName = 'deakin:how-to-apply-equity-schemes:pageView';
        break;                              

    // Entry Pathways deakin pages
    case (/\/entry-pathways/.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'entry-pathways';
    	pageActionName = 'deakin:entry-pathways:pageView';
    	break;
        
    
    case (/\/how-to-apply-for-a-research-degree$/.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'how-to-apply';
    	pageActionName = 'deakin:how-to-apply_e49:pageView';
    	/*mcpPageMbox[0] = {
    ...
    // course pages
    // view item fires from within launch, done to keep this script light and fast
    case (/\/(course|tri3-course|stackable-short-courses)\//.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'course_detail';
    	launchMCPEvent = 'View Catalog Object';
    	pageActionName = 'deakin:course/courseCategory:pageView';
    	/*mcpPageMbox[0] = {
    		name: "navigation_logo",
    		selector: ".global-header__navigation > .logo"
    	};*/
mcpPageMbox[0] = {
  ...
  selector: ".section.accordion.mt-0"
};
mcpPageMbox[1] = {
  name: "course-structure",
  selector: "#course-structure"
};
mcpPageMbox[2] = {
name: "course-yellow-copy-callout",
  selector: "section.copy-callout.standard.full-width.yellow"
};
    	break;
    	
    // Unit page
    case (/\/unit\?unit=.$/.test(window.location.pathname)):
        mcpLoad = true;
        pageTypeName = 'unit';
        //launchMCPEvent = 'category_course_list';
        pageActionName = 'deakin:course/unit:pageView';
        /*mcpPageMbox[0] = {
    		name: "navigation_logo",
    		selector: ".global-header__navigation > .logo"
    	};*/
    ...
    // find a course by study area
    case (/\/find-a-course$/.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'department';
    	//launchMCPEvent = 'category_course_list';
    	pageActionName = 'deakin:find-a-coursecourseCategory:pageView';
    	/*mcpPageMbox[0] = {
    		name: "navigation_logo",
    		selector: ".global-header__navigation > .logo"
    	};*/
    ...
    // find a course by: undergrad|postgrad|double|short|ATAR (check regex after debugging)
    case (/(\/find-a-course((\/.*(grad|double|short))|-by-atar$)|\/trimester)/.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'category_course_list';
    	launchMCPEvent = 'category_course_list';
    	pageActionName = 'deakin:find-a-coursecourseCategory:pageView';
    	/*mcpPageMbox[0] = {
    		name: "navigation_logo",
    ...
    // find a course by: ATAR (check regex after debugging)
    case (/(\/find-a-course-by-atar$)/.test(window.location.pathname)):
        mcpLoad = true;
        pageTypeName = 'department';
        //launchMCPEvent = 'category_course_list';
        pageActionName = 'deakin:find-a-coursecourseCategory:pageView';
    ...
    // domestic-prospective-student-enquiry page
    case (/domestic-prospective-student-enquiry/.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'Enquiry Form page';
    	pageActionName = 'deakin:domestic-prospective-student-enquiry:pageView';
    	/*mcpPageMbox[0] = {
    		name: "navigation_logo",
    		selector: ".global-header__navigation > .logo"
    	};*/
    ...
    // find a research
    case (/\/find-a-research-degree-or-phd$/.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'category_research_list';
    	launchMCPEvent = 'category_course_list';
    	pageActionName = 'deakin:find-a-coursecourseCategory:pageView';
    	/*mcpPageMbox[0] = {
    		name: "navigation_logo",
    	...
    	break;
    // research
    case (/\/research\//.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'research_node';
    	//launchMCPEvent = 'category_course';
    	pageActionName = 'deakin:research:pageView';
    	/*mcpPageMbox[0] = {
    		name: "navi gation_logo",
    		selector: ".global-header__navigation > .logo"
    	};*/
    	break;
    
    // find a course by study - sub pages
    case (/\/find-a-course\//.test(window.location.pathname)):
    	mcpLoad = true;
    	pageTypeName = 'department-SubPage';
    	launchMCPEvent = 'category_course_list';
    	pageActionName = 'deakin:find-a-coursecourseCategory:pageView';
    	/*mcpPageMbox[0] = {
    		name: "navigation_logo",
    ...
    /*****************************Do not add/modify code below**********************************/
    
    // detects courseCategory on find a course or course pages
    if (/^(\/|\/tri3\-)course/.test(window.location.pathname) && window.location.pathname.search('/\/unit') < 0) {
    		// course pages
    		var courseCategory = (/research/.test(window.document.querySelector("meta[name='dkncoursetype']").content)) ? 'research' :
    				(/\/associate/.test(window.location.pathname)) ? 'undergraduate/associate' :
    						(/\/bachelor/.test(window.location.pathname)) ? 'undergraduate/bachelor' :
    								(/\/diploma/.test(window.location.pathname)) ? 'undergraduate/diploma' :
    										(/(research|doctor)/.test(window.location.pathname)) ? 'research' :
    												(/\/master/.test(window.location.pathname)) ? 'postgraduate/masters' :
    														(/\/.*diploma/.test(window.location.pathname)) ? 'postgraduate/graduate-diploma' :
    																(/\/.*certificate/.test(window.location.pathname)) ? 'postgraduate/graduate-certificate' :
    																		(/\/.*course-by-atar/.test(window.location.pathname)) ? '/by-atar' :
    																				'/by-study-area';
    		courseCategory = (/^\/tri/.test(window.location.pathname)) ? courseCategory.replace(/undergraduate|postgraduate/, 'trimester') : courseCategory;
    	} else if (/(\/find-a-(course|research)|\/trimester)/.test(window.location.pathname)) {
    		// course category pages
    		var courseCategory = (/\/.*course\/undergrad/.test(window.location.pathname)) ? '/undergraduate' :
    								(/\/.*course\/postgrad/.test(window.location.pathname)) ? '/postgraduate' :
    										(/\/.*course\/double/.test(window.location.pathname)) ? '/double-degrees' :
    												(/\/.*course\/short/.test(window.location.pathname)) ? '/short-courses' :
    													(/^\/trimester/.test(window.location.pathname)) ? '/trimester' :
    														(/\/.*course\-by\-atar/.test(window.location.pathname)) ? '/by-atar' :
    															(/\/find-a-research/.test(window.location.pathname)) ? '/research' :
    																	'/by-study-area';
    	}
    
    
    // No Code change required in the section below, its for Lead MCP developer for enabling features.
    
    if (/courseCategory/.test(pageActionName)) {
            pageActionName = pageActionName.replace('courseCategory', courseCategory);
            if (/course_detail/.test(pageTypeName)) {
                
                triDetails = document.querySelector("meta[name='dkncourseintakes']").getAttribute("content");
                ...
                function getTrimester() {
                    ...
                    const trimester1End = new Date(year, 3, 3);   
                    const trimester2End = new Date(year, 6, 30); 

                    if (today <= trimester1End) {
                        return "Trimester1";
                    } else if (today <= trimester2End) {
                        return "Trimester2";
                    } else {
                        return "Trimester3";
                    }
                }
                var currentTrimester = getTrimester();

                if( currentTrimester == 'Trimester3' && /Trimester 1/.test(triDetails)) {
                    promoted = '/Trimester1_'+nextYear;
                } else if(currentTrimester == 'Trimester1' && /Trimester 2/.test(triDetails) ) {
                    promoted = '/Trimester2_'+year;
                } else if (currentTrimester == 'Trimester2' && /Trimester 3/.test(triDetails)) {
                    promoted = '/Trimester3_'+year;
                }
                
                pageActionName = pageActionName.replace(':pageView', promoted + ':pageView');
                if (/testMachine/.test(window.location.search) > 0 || /testMachine=true/.test(window.document.cookie)) {
                    window.console.log("pageActionName::",pageActionName);
                }
            }
        } 
    
    
    // Only if the page is declared above, will the MCP beacon initialise else not
    // This gives us the ability to load beacon on selected pages
    if (mcpLoad) {
    	SalesforceInteractions.init({
    		cookieDomain: "deakin.edu.au"
    	}).then(() => {
    		const sitemapConfig = {
    			/* Global content zones defined in this section */
    			global:{
                    onActionEvent: (actionEvent) => {
                        if (SalesforceInteractions.mcis.cookie.get('testMachine')) {
                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.testMachine = SalesforceInteractions.mcis.cookie.get('testMachine');
                        }
                        return actionEvent;
                    },
    				contentZones: [
    				    { name: "navigation_logo", selector: ".global-header__navigation > .logo" },
    				    { name: "hero_banner", selector: "#banner" },
    				    { name: "course_search", selector: "#global-search" },
                        { name: "find_course_search", selector: "section.course-search-bar" },
    				    { name: "footer", selector: "footer" },
                        { name: "pubw_body", selector: "body" }
    				    
    				],        
    			},
    			pageTypes: [
    				/* Define each pageType in this object, sequenced */
    				// default for rest
    				{
    					isMatch: () => (pageTypeName.length > 0 ),
    					name: pageTypeName,
    					interaction: {
    						name: pageActionName,
    					},
    					contentZones: mcpPageMbox,
    				},
    			]
    		};
    ...
    // send MCP events to launch
    	if (launchMCPEvent.length > 0) {
            setTimeout(function(){ 
                window._satellite.track('mcp_events', {
                mcpEventDetail: launchMCPEvent
            });
              if (/testMachine/.test(window.location.search) > 0 || /testMachine=true/.test(window.document.cookie)) {
                window.console.log("mcpEvent sent::",launchMCPEvent);
              }
            }, 2000);
        }
    }
   
    // console log config for debuging
    if (/testMachine/.test(window.location.search) > 0 || /testMachine=true/.test(window.document.cookie)) {
    	document.cookie = 'testMachine=true; domain=deakin.edu.au; path=/';
    	window.console.log('account::', SalesforceInteractions.mcis.getSdkConfig().account, '\npersona::', SalesforceInteractions.mcis.cookie.get('persona'), '\ndataset::', SalesforceInteractions.mcis.getSdkConfig().dataset);
    	window.console.log('pageType::', pageTypeName,'\nlaunchMCPEvent::', launchMCPEvent,'\npageActionName::', pageActionName);
    }
}
} catch (e) {
    if (typeof window.Evergage === "object" && typeof window.Evergage.getVersion === "function" && window.Evergage.getVersion() >= 5) {
